...
class GetListCustomerBccsAdapter extends ArrayAdapter<CustIdentityDTO> {
...
//				}
			...
			if (!CommonActivity.isNullOrEmpty(custIdentityDTO.getIdIssueDate())) {
				if(custIdentityDTO.getCustomer().getCustId() != null){
			...
			if (imageListenner != null && custIdentityDTO.getCustId() != null) {
