package com.viettel.gem.widget.loading;
...
public class LoadingIndicatorView extends RelativeLayout {
  ...
  public LoadingIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    int layout_width = ta.getDimensionPixelSize(0, LayoutParams.MATCH_PARENT);
    int layout_height = ta.getDimensionPixelSize(1, LayoutParams.MATCH_PARENT);
