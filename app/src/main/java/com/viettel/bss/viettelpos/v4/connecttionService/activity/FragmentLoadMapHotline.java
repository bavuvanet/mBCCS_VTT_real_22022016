...
//						}
		...
		Utils.setDataSpinner(FragmentLoadMapHotline.this, lstMapType, spinner_loaibando);
		...
		CommonActivity.checkConnectionMap(FragmentLoadMapHotline.this);
		...
		btnkiemtra.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (txtmahopcap.getText() != null
					...
					if (CommonActivity.isNetworkConnected(FragmentLoadMapHotline.this)) {
...
//			startActivity(intent);
//			finish();
			 LoginDialog dialog = new LoginDialog(FragmentLoadMapHotline.this,
                     ";cm.connect_sub_CD;");
