...
public class GetConectortAdapter extends BaseAdapter{
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if(pakageChargeBeans != null && !CommonActivity.isNullOrEmpty(pakageChargeBeans.getNodeCode())){
			holder.txtpstn.setText(pakageChargeBeans.getNodeCode());
		}
		return mView;
	}
