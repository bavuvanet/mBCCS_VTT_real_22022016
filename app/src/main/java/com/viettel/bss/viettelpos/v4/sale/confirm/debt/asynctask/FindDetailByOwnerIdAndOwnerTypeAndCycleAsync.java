...
public class FindDetailByOwnerIdAndOwnerTypeAndCycleAsync extends AsyncTaskCommon<String, Void, List<ConfirmDebitTransDTO>> {

    private String cycleDate;
    private Long status;

    public FindDetailByOwnerIdAndOwnerTypeAndCycleAsync(Activity context,
                                                        OnPostExecuteListener<List<ConfirmDebitTransDTO>> listener,
                                                        View.OnClickListener moveLogInAct, String cycleDate, Long status) {
        super(context, listener, moveLogInAct,context.getString(R.string.getting_debt_detail));
    ...
    protected List<ConfirmDebitTransDTO> doInBackground(String... params) {
        {
            ...
            String original = "";
            SaleOutput result;
            String methodName = "findDetailByOwnerIdAndOwnerTypeAndCycle";
            try {
