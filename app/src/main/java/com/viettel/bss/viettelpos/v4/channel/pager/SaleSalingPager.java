...
public class SaleSalingPager extends Page{

	public SaleSalingPager(ModelCallbacks callbacks, String title) {
	...
	public Fragment createFragment() {
		...
		return FragmentSaleSaling.create(getKey(), FragmentSaleSaling.FUNCTION_SALING);
	}
