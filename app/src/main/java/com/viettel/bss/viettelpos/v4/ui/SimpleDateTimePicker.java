...
public class SimpleDateTimePicker {
	...
	private final CharSequence mDialogTitle;
	private final Date mInitDate;
	private final DateTimePicker.OnDateTimeSetListener mOnDateTimeSetListener;
	...
	private SimpleDateTimePicker(CharSequence dialogTitle, Date initDate,
			DateTimePicker.OnDateTimeSetListener onDateTimeSetListener, FragmentManager fragmentManager) {
