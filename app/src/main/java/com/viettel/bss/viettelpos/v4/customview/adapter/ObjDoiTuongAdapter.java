...
public class ObjDoiTuongAdapter extends BaseAdapter {
	private final ArrayList<SpecObject> arrayList;
	private final Activity mContext;

	// private String mLoaiThueBao[];

	public ObjDoiTuongAdapter(ArrayList<SpecObject> arrayList, Activity context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.txtItemSpinner.setText(arrayList.get(position).getCodeName());
		return mView;
	}
