...
public class GetDistrictCDAdapter extends BaseAdapter {
	private final Context mContext;
	private final ArrayList<AreaObj> arrAreaObjs = new ArrayList<>();
    private final ArrayList<AreaObj> arraylist = new ArrayList<>();

	public GetDistrictCDAdapter(ArrayList<AreaObj> arr, Context context) {
		if (arr != null) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (customerGroupBeans != null
				&& !CommonActivity.isNullOrEmpty(customerGroupBeans
						.getName())) {
			holder.txtpstn.setText(customerGroupBeans.getDistrict() + " "+customerGroupBeans.getName());
		}
