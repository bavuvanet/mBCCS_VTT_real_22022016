...
public class RegisterInfoAdapter extends BaseAdapter {
	private final ArrayList<LoaiGiayToObj> arrayList;
	private final Activity mContext;

	// private String mLoaiThueBao[];

	public RegisterInfoAdapter(ArrayList<LoaiGiayToObj> arrayList,
			Activity context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.txtItemSpinner.setText(arrayList.get(position).getParValue());
		return mView;
	}
