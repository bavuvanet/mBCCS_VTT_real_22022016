...
public class FragmentSearchBank extends GPSTracker implements OnClickListener,OnItemClickListener{
	...
	private BankMain pakageBundeBean = new BankMain();
	private ArrayList<Bank> arrChargeBeans = new ArrayList<Bank>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mBundle != null) {
			pakageBundeBean = (BankMain) mBundle.getSerializable("BankKey");
...
//		getActivity().onBackPressed();
	...
	private void addActionBar() {
		...
		btnHome.setOnClickListener(new OnClickListener() {
			...
			CommonActivity.callphone(FragmentSearchBank.this, Constant.phoneNumber);	
			}
		});
