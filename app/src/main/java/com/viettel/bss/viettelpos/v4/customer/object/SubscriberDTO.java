...
public class SubscriberDTO implements Serializable {
    ...
    @Element(name = "subObject", required = false)
    ...
    public String getOmniProcessId() {
        return omniProcessId;
    }

    public void setOmniProcessId(String omniProcessId) {
    ...
    private boolean isCustomerInfoInvalid = false;

    public void setCustomerInfoInvalid(boolean customerInfoInvalid) {
        isCustomerInfoInvalid = customerInfoInvalid;
    }

    public boolean isCustomerInfoInvalid() {
        return isCustomerInfoInvalid;
    }
    ...
    public String buildSubXml(Context context, String root,
        ...
        //omni
        xml.append("<omniProcessId>")
                .append(getOmniProcessId())
                .append("</omniProcessId>");
