...
@SuppressLint("NewApi") public class FragmentConnectionInfoSettingHotLine extends GPSTracker implements
		OnClickListener, OnChangeSpiner, OnTouchListener {
	private Button btnkyhopdong, btnsinhacc;
	...
	private TextView txttinhTP, txtquanhuyen, txtphuongxa, txtdiachidaydu,
			edit_sogiaytoDD;
	private EditText edit_ngaycap;
	private EditText edtnoicap;
	private EditText txthoten, edtmaKHCD, edit_tenKHDD, edit_ngaysinhd,
			edit_quoctich;
	private LinearLayout lnIptinh, lnmatkhau;
	private ArrayList<SubGroupBeans> arrSubGroupBeans = new ArrayList<SubGroupBeans>();
	...
	private ArrayList<String> arrListIp = new ArrayList<String>();
	private ArrayList<String> arrListIsdnPstn = new ArrayList<String>();
	private ArrayList<String> arrListIsdnNGN = new ArrayList<String>();
	private ArrayList<NotifyBean> arrNotifyBeans = new ArrayList<NotifyBean>();
	private ArrayList<AreaBean> arrPrecint = new ArrayList<AreaBean>();
	private ArrayList<HTTTBean> arrHtttBeans = new ArrayList<HTTTBean>();
	...
	private SubRequest subRequest = null;
	...
	public CustommerByIdNoBean custommer = new CustommerByIdNoBean();
	private ArrayList<ObjThongTinHH> mArrayListThongTinHH = new ArrayList<ObjThongTinHH>();
	// private SupplyInforBean supplyInforBean = new SupplyInforBean();
	public static FragmentConnectionInfoSettingHotLine instance = null;
	...
	private ArrayAdapter<String> adapterProgram;
	private ArrayAdapter<String> adapterMonths;
	private ArrayAdapter<String> adapterHTCC;

	// init list map
	private ArrayList<SupplyProgramBean> arrMapProgramBeans = new ArrayList<SupplyProgramBean>();
	private List<SupplyBaseBean> arrMapBaseBeans = new ArrayList<SupplyBaseBean>();

	// init list stock model for sign contract
	private Map<String, SubStockModelRelReq> mapSubStockModelRelReq = new HashMap<String, SubStockModelRelReq>();
	...
	private String reclainDatetime = "";
	...
	public static final int TYPE_CK_CUOC_HD = 3;
	...
	private ArrayList<ConTractBean> arrTractBeans = new ArrayList<ConTractBean>();
	private String contractNo = "";
	private String contractId = "";
	private ConTractBean conTractBean = new ConTractBean();

	private ArrayList<Spin> arrHTTTHD = new ArrayList<Spin>();
	private ArrayList<Spin> arrLOAIHD = new ArrayList<Spin>();
	private ArrayList<Spin> arrCKC = new ArrayList<Spin>();
	private ArrayList<Spin> arrINCT = new ArrayList<Spin>();
	private ArrayList<Spin> arrHTTBC = new ArrayList<Spin>();
	private ArrayList<Spin> arrTTBSHD = new ArrayList<Spin>();
	...
	private ArrayList<ActivesObj> arrActivesObjObj = new ArrayList<ActivesObj>();
	...
	private ArrayList<TypePaperBeans> arrTypePaperBeansOffer = new ArrayList<TypePaperBeans>();
	private ArrayList<AreaObj> listSex = new ArrayList<AreaObj>();
	...
	private Date datengaynhothu = null;
	...
	private LinearLayout lnParentContract;
	...
	private LinearLayout lninchitiet;
	...
	private LinearLayout lngiaytoxacminh, lnttgiaytoxacminh, lnViewddhd,
			lnviewgtxm;
	...
	// bo sung khuyen mai trai nghiem
	private LinearLayout lnkmtrainghiem;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		effectDate = caleffectDate.getTime();
		...
		expireDate = calexpireDate.getTime();
		...
		signDateContractOffer = calesignDateContractOffer.getTime();
		...
		issueDateOffer = calissueDateOffer.getTime();
		...
		birhDateDD = calbirhDateDD.getTime();
		...
		if (!CommonActivity.isNullOrEmpty(conTractBean.getContractId())) {
			...
			if (CommonActivity.isNullOrEmpty(txtdctbc.getText().toString())) {
				CommonActivity.createAlertDialog(
						FragmentConnectionInfoSettingHotLine.this,
	...
	private void showDatePickerSign(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					...
					signDate = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this, AlertDialog.THEME_HOLO_LIGHT, callback,
					yearsignDate, monthsignDate, daysignDate);
		}
	...
	private void showDatePickerEffectDate(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					...
					effectDate = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this, AlertDialog.THEME_HOLO_LIGHT, callback,
					yeareffectDate, montheffectDate, dayeffectDate);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerExpireDate(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					...
					expireDate = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this, AlertDialog.THEME_HOLO_LIGHT, callback,
					yearexpireDate, monthexpireDate, dayexpireDate);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerSignContractOffer(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					...
					signDateContractOffer = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this, AlertDialog.THEME_HOLO_LIGHT, callback,
					yearsignDateContractOffer, monthsignDateContractOffer,
					dayesignDateContractOffer);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerIssueDateOffer(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					...
					issueDateOffer = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this,AlertDialog.THEME_HOLO_LIGHT, callback,
					yearissueDateOffer, monissueDateOffer, dayissueDateOffer);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerbirhDateDD(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					...
					birhDateDD = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this, AlertDialog.THEME_HOLO_LIGHT, callback,
					yearbirhDateDD, monbirhDateDD, daybirhDateDD);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerNgaynhothu(final EditText edtngaycap) {
		OnDateSetListener callback = new OnDateSetListener() {
			...
			public void onDateSet(DatePicker view, int year1, int monthOfYear,
				...
				try {
					datengaynhothu = dbUpdateDateTime.parse(mNgaycaidat);
				} catch (Exception e) {
					e.printStackTrace();
				}
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(
					FragmentConnectionInfoSettingHotLine.this, AlertDialog.THEME_HOLO_LIGHT, callback,
					yearngaynhothu, monngaynhothu, dayngaynhothu);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	public void unitView() {
		...
		custommer = FragmentInfoCustomerHotLine.custommer;
		typePaper = custommer.getIdType();
		// get bunder
		getDataBundle();
		lnIptinh = (LinearLayout) findViewById(R.id.lnIptinh);
		editmatkhau = (EditText) findViewById(R.id.editmatkhau);
		lnmatkhau = (LinearLayout) findViewById(R.id.lnmatkhau);

		// bo sung NGN PPPOE
		lnPPPOE = (LinearLayout) findViewById(R.id.lnPPPOE);
		...
		btnsinhaccPPPOE = (Button) findViewById(R.id.btnsinhaccPPPOE);
		...
		spinner_type_giay_to_parent
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (typePaperBeans.getParType().isEmpty() || "3".equals(typePaperBeans.getParType())) {
		...
		if (account != null && !account.isEmpty()) {
			editmatkhau.setText(CommonActivity
					.genPasswordAuto(FragmentInfoCustomerHotLine.account));
		}
		...
		// spinner_hthm = (Spinner) findViewById(R.id.spinner_hthm);
		// spinner_makm = (Spinner) findViewById(R.id.spinner_makm);
		...
		txttinhTP = (TextView) findViewById(R.id.txttinhTP);
		txtquanhuyen = (TextView) findViewById(R.id.txtquanhuyen);
		...
		btnsinhacc = (Button) findViewById(R.id.btnsinhacc);
		...
		lnkmtrainghiem = (LinearLayout) findViewById(R.id.lnkmtrainghiem);
		...
		if (serviceType.equals("U")) {
			...
			AsynGetPromotionUnit asynGetPromotionUnit = new AsynGetPromotionUnit(
					FragmentConnectionInfoSettingHotLine.this);
			asynGetPromotionUnit.execute(txttinhTP.getText().toString().trim(),
					productCode);
		...
		lnttgiaytoxacminh = (LinearLayout) findViewById(R.id.lnttgiaytoxacminh);
		lnViewddhd = (LinearLayout) findViewById(R.id.lnViewddhd);
		lnviewgtxm = (LinearLayout) findViewById(R.id.lnviewgtxm);
		if (custommer.getCustomerAttribute() != null
				&& !CommonActivity.isNullOrEmpty(custommer
						.getCustomerAttribute().getIdNo())) {
		...
		if (CommonActivity
				.isNetworkConnected(FragmentConnectionInfoSettingHotLine.this) == true) {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (arg2 > 0) {
							...
							if (idSubGroup != null && !idSubGroup.isEmpty()
								...
								if (CommonActivity
										.isNetworkConnected(FragmentConnectionInfoSettingHotLine.this)) {
						...
						if (arg2 > 0) {
							...
							if (CommonActivity
								...
								getHTHMAsyn.execute(offerId, serviceType,
										areaBean.getProvince(), areaBean
												.getDistrict(), txtphuongxa
												.getText().toString(),
										custommer.getCusGroupId(), custommer
												.getCusType(), idSubGroup,
										subType);
							} else {
								CommonActivity
										.createAlertDialog(
		...
		// // TODO Auto-generated method stub
		// if (position > 0) {
		// regType = arrHthmBeans.get(position).getCode();
		// Log.d("regType", regType);
		// reasonId = arrHthmBeans.get(position).getReasonId();
		...
		// TODO XU LY THEM MOI THONG TIN HOP DONG
		// private Spinner spinner_hopdong, spinner_loaihopdong, spinner_httthd,
		// spinner_chukicuoc, spinner_inchitiet, spinner_httbc,
		// spinner_ttbosung, spinner_plhopdong;
		// private EditText edtsohd, edtsoinHD, edtnguoithanhtoan, edit_ngayky,
		// edit_ngayhieuluc, edit_ngayhethan, edtdtcdtbc, txtdtdidongtbc,
		// edtplhdong, edtcvplhd, edit_ngaykyhd, edtmagiaytoCD,
		// edit_ngaycappl, edtmanoicapCD;
		// private TextView txtdctbc;
		...
		lninchitiet = (LinearLayout) findViewById(R.id.lninchitiet);
		...
		lnParentContract = (LinearLayout) findViewById(R.id.lnParentContract);
		...
		// spinner_hopdong.setOnItemSelectedListener(new
		...
		//
		// conTractBean = arrTractBeans.get(arg2);
		//
		...
		// getContractOfferByContractIdAsynTask = new
		// GetContractOfferByContractIdAsynTask(
		// FragmentConnectionInfoSettingHotLine.this);
		// getContractOfferByContractIdAsynTask
		...
		//
		// arrContractOffersObj = new ArrayList<ContractOffersObj>();
		...
		// hinh thuc thong bao cuoc hop dong
		spinner_httbc.setOnItemSelectedListener(new OnItemSelectedListener() {
	...
	private void reloadHDOld(ConTractBean conTractBeanPr) {
		...
		try {
			...
			if (conTractBeanPr.getHome() != null) {
				address.append(conTractBeanPr.getHome() + " - ");
			}
			if (conTractBeanPr.getStreetName() != null) {
				address.append(conTractBeanPr.getStreetName() + " - ");
			}
			if (conTractBeanPr.getStreetBlock() != null) {
				address.append(conTractBeanPr.getStreetBlock() + " - ");
			}
			if (conTractBeanPr.getPrecinct() != null) {

				address.append(conTractBeanPr.getPrecinct() + " - ");
			}
			if (conTractBeanPr.getDistrict() != null) {
				address.append(conTractBeanPr.getDistrict() + " - ");
			}
	...
	private void showPrecint(final ArrayList<AreaBean> arrAreaBeans) {
		...
		GetPrecintAdapter adapPrecintAdapter = new GetPrecintAdapter(
				arrAreaBeans, FragmentConnectionInfoSettingHotLine.this);
...
//				if(!"-1".equals(maKM) && !CommonActivity.isNullOrEmpty(productCode)){
...
//				}
	...
	// else {
	// Dialog dialog = CommonActivity.createAlertDialog(
	// FragmentConnectionInfoSettingHotLine.this, getResources()
	...
	public void onClick(View v) {
		...
		case R.id.btnkyhopdong:
			...
			if (validateInputContract()) {
				if (txthoten.getText().toString() != null
					...
					Toast.makeText(FragmentConnectionInfoSettingHotLine.this,
					...
					if (serviceType.equals("N")) {
						...
						if (CommonActivity
							...
							generaAccAsyn.execute(serviceType,
									FragmentInfoCustomerHotLine.custommer
											.getNameCustomer(), areaBean
											.getProvince());
						} else {
							CommonActivity
									.createAlertDialog(
		...
		case R.id.txtdctbc:
			...
			// || strDistris == null || strDistris.length() == 0) {
			// CommonActivity.createAlertDialog(
			// FragmentConnectionInfoSettingHotLine.this,
			...
			Intent i = new Intent(FragmentConnectionInfoSettingHotLine.this,
		...
		case R.id.txtdcgtxm:
			...
			Intent i1 = new Intent(FragmentConnectionInfoSettingHotLine.this,
					CreateAddressCommon.class);
		...
		case R.id.btnloaihopdong:
			...
			AsyntaskGetListAllCommon asyntaskGetListAllCommon2 = new AsyntaskGetListAllCommon(
					FragmentConnectionInfoSettingHotLine.this, TYPE_LOAI_HD);
		...
		case R.id.btnhttthd:
			...
			AsyntaskGetListAllCommon asnGetHHTH = new AsyntaskGetListAllCommon(
					FragmentConnectionInfoSettingHotLine.this, TYPE_HTTTHD);
			asnGetHHTH.execute();
			break;
		case R.id.btnchukicuoc:
			...
			AsyntaskGetListAllCommon asnGetBillCycle = new AsyntaskGetListAllCommon(
					FragmentConnectionInfoSettingHotLine.this, TYPE_CK_CUOC_HD);
		...
		case R.id.btnhttbc:
			...
			AsyntaskGetListAllCommon asnHTTBC = new AsyntaskGetListAllCommon(
					FragmentConnectionInfoSettingHotLine.this, TYPE_HTTBC_HD);
			asnHTTBC.execute();
			break;
		case R.id.btnttbosung:
			...
			AsyntaskGetListAllCommon asnTTBS = new AsyntaskGetListAllCommon(
					FragmentConnectionInfoSettingHotLine.this, TYPE_TTBS_HD);
			asnTTBS.execute();
			break;
		case R.id.btnnhomkh:
			if (custommer.getCustomerAttribute() != null
	...
	public void checkInputSignContract() {
	...
	OnClickListener signContractCListener = new OnClickListener() {
...
//			arrPromotionTypeBeans.add(1, promotionTypeBeans1);
	...
	final OnClickListener moveLogInAct = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			FragmentConnectionInfoSettingHotLine.this.finish();
	...
	public class SignContractAsyn extends AsyncTask<String, Void, Void> {
		...
		protected Void doInBackground(String... arg0) {
			...
			CustommerByIdNoBean custommerByIdNoBean = FragmentInfoCustomerHotLine.custommer;
			...
			subReqDeployment = new SubReqDeployment(
					...
					surveyOnline.getVendorCode(),surveyOnline.getConnectorType());
			...
			subRequest = new SubRequest(lineType, editmatkhau.getText()
					.toString(), editisdnoracc.getText().toString(), "",
					idSubGroup, subType, "", maKM, regType, ipStatic, txthoten
			...
			List<SubStockModelRelReq> lstSubStockModelRelReq = new ArrayList<SubStockModelRelReq>();
			if (mapSubStockModelRelReq != null
					&& !mapSubStockModelRelReq.isEmpty()) {
				lstSubStockModelRelReq.addAll(mapSubStockModelRelReq.values());
			}
			luuHopDong(areaBean.getProvince(), areaBean.getDistrict(),
					txtphuongxa.getText().toString(),
					areaBean.getFullAddress(), gponGroupAccountId,
					custommerByIdNoBean, contract, subRequest,
					subReqDeployment, lstSubStockModelRelReq);
			return null;
		}
		...
		private void luuHopDong(String province, String district,
			...
			try {
				...
				rawData.append("<precint>" + precinct);
				rawData.append("</precint>");

				rawData.append("<address>" + fullAddress);
				rawData.append("</address>");
				if (tenduong != null && !tenduong.isEmpty()) {
					rawData.append("<streetName>" + tenduong);
					rawData.append("</streetName>");
				}

				if (sonha != null && !sonha.isEmpty()) {
					rawData.append("<home>" + sonha);
					rawData.append("</home>");
				}

				rawData.append("<customerPosition>"
						+ surveyOnline.getCustomerPossition());
				rawData.append("</customerPosition>");

				rawData.append("<cableBoxPosition>"
						+ surveyOnline.getCableBoxPosition());
				rawData.append("</cableBoxPosition>");

				rawData.append("<polylineData>"
						+ surveyOnline.getPolylineData());
				rawData.append("</polylineData>");
				...
				if (mainSubId != null && !mainSubId.equals("")) {
					rawData.append("<mainSubId>" + mainSubId);
				...
				if (custommer.getCustId() != null
					...
					rawData.append("<custId>" + custommer.getCustId());
					...
					if (!CommonActivity.isNullOrEmpty(custommer
						...
						rawData.append("<idNo>" + custommer.getIdNo());
						rawData.append("</idNo>");
					}
				} else {
					if (custommer.getAddreseCus() != null
							&& !custommer.getAddreseCus().isEmpty()) {
						rawData.append("<address>" + custommer.getAddreseCus());
						rawData.append("</address>");
						// paramCustomer.put("address",
						// custommer.getAddreseCus());
					}
					rawData.append("<name>" + custommer.getNameCustomer());
					rawData.append("</name>");
					// paramCustomer.put("name", custommer.getNameCustomer());
					rawData.append("<busType>" + custommer.getCusType());
					rawData.append("</busType>");

					rawData.append("<province>" + custommer.getProvince());
					rawData.append("</province>");
					rawData.append("<district>" + custommer.getDistrict());
					rawData.append("</district>");
					rawData.append("<precinct>" + custommer.getPrecint());
					rawData.append("</precinct>");

					rawData.append("<areaCode>" + custommer.getProvince()
							+ custommer.getDistrict() + custommer.getPrecint() + custommer.getStreet_block());
					rawData.append("</areaCode>");
					
					rawData.append("<streetBlock>" + custommer.getStreet_block());
					rawData.append("</streetBlock>");
					rawData.append("<streetName>" + custommer.getStreet());
					rawData.append("</streetName>");
					rawData.append("<home>" + custommer.getHome());
					rawData.append("</home>");
					...
					if (!CommonActivity.isNullOrEmpty(custommer
						...
						rawData.append("<tin>" + custommer.getTin());
						rawData.append("</tin>");
						// paramCustomer
						...
						rawData.append("<idNo>" + custommer.getIdNo());
						rawData.append("</idNo>");
						rawData.append("<sex>" + custommer.getSex());
						rawData.append("</sex>");
					}
					...
					if (!CommonActivity.isNullOrEmpty(custommer
						...
						if (custommer.getIdType() != null
							...
							rawData.append("<idType>" + custommer.getIdType());
							rawData.append("</idType>");
							if ("3".equals(custommer.getIdType())) {
								rawData.append("<idExpireDateStr>"
										+ custommer.getStrIdExpire());
								rawData.append("</idExpireDateStr>");
							}
						}
					}
				...
				if (custommer.getCustomerAttribute() != null) {
					if (!CommonActivity.isNullOrEmpty(custommer
						...
						rawData.append("<birthDateStr>"
								+ custommer.getCustomerAttribute()
										.getBirthDate());
						rawData.append("</birthDateStr>");
						rawData.append("<idType>"
								+ custommer.getCustomerAttribute().getIdType());
						rawData.append("</idType>");
						rawData.append("<idNo>"
								+ custommer.getCustomerAttribute().getIdNo());
						rawData.append("</idNo>");
						...
						rawData.append("</issuePlace>");
						rawData.append("<name>"
								+ custommer.getCustomerAttribute().getName());
						rawData.append("</name>");
						rawData.append("</customerAttribute>");
					}
				}
				...
				if (!CommonActivity.isNullOrEmpty(conTractBean.getContractId())) {
					...
					if (!CommonActivity.isNullOrEmpty(edtplhdong.getText()
						...
						rawData.append("<contractOfferId>"
								+ edtplhdong.getText().toString().trim());
						rawData.append("</contractOfferId>");
					} else {

						rawData.append("<represent>"
								+ edtdaidienpl.getText().toString().trim());
						rawData.append("</represent>");
						if (typePaperBeansOffer != null) {
							rawData.append("<idType>"
									+ typePaperBeansOffer.getParType());
							rawData.append("</idType>");
						}

						rawData.append("<representPosition>"
								+ edtcvplhd.getText().toString().trim());
						rawData.append("</representPosition>");
						rawData.append("<strSignDatetime>"
								+ edit_ngaykyhd.getText().toString().trim());
						rawData.append("</strSignDatetime>");
						rawData.append("<idNo>"
								+ edtmagiaytoCD.getText().toString().trim());
						rawData.append("</idNo>");
						rawData.append("<strIssueDatetime>"
								+ edit_ngaycappl.getText().toString().trim());
						rawData.append("</strIssueDatetime>");
						rawData.append("<issuePlace>"
								+ edtmanoicapCD.getText().toString().trim());
						rawData.append("</issuePlace>");
					}
					rawData.append("</contractOffer>");
					...
					rawData.append("<strBankContractDate>"
							+ edit_ngaynhothu.getText().toString());
					rawData.append("</strBankContractDate>");
					rawData.append("<bankContractNo>"
							+ edthdnhothu.getText().toString().trim());
					rawData.append("</bankContractNo>");
					rawData.append("<account>"
							+ edttkoanhd.getText().toString().trim());
					rawData.append("</account>");
					rawData.append("<accountName>"
							+ edttentkoan.getText().toString().trim());
					rawData.append("</accountName>");
					if (searchBank != null) {
						rawData.append("<bankCode>" + searchBank.getBankCode());
					...
					rawData.append("<payer>"
							+ Html.escapeHtml(edtnguoithanhtoan.getText().toString().trim()));
					rawData.append("</payer>");
					Spin spinloaihd = (Spin) spinner_loaihopdong
							.getSelectedItem();
					if (spinloaihd != null) {
						rawData.append("<contractType>" + spinloaihd.getId());
					...
					rawData.append("<billAddress>"
							+ edtdchdcuoc.getText().toString().trim());
					rawData.append("</billAddress>");
					...
					if (spinINCT != null) {
						...
						rawData.append("<printMethodCode>" + spinINCT.getId());
					...
					if (spinHTTBC != null) {
						rawData.append("<noticeCharge>" + spinHTTBC.getId());
						rawData.append("</noticeCharge>");
					}

					rawData.append("<email>"
							+ edtemailtbc.getText().toString().trim());
					rawData.append("</email>");

					rawData.append("<telFax>"
							+ edtdtcdtbc.getText().toString().trim());
					rawData.append("</telFax>");

					rawData.append("<telMobile>"
							+ txtdtdidongtbc.getText().toString().trim());
					rawData.append("</telMobile>");
					if (areaProvicial != null) {
						rawData.append("<province>"
								+ areaProvicial.getProvince());
						rawData.append("</province>");
					}
					if (areaPrecint != null) {
						rawData.append("<precinct>" + areaPrecint.getPrecinct());
						rawData.append("</precinct>");
					}
					...
					rawData.append("<streetName>" + areaFlow);
					rawData.append("</streetName>");
					rawData.append("<home>" + areaHomeNumber);
					rawData.append("</home>");
					...
					if (spinINBS != null) {
						rawData.append("<contractPrint>" + spinINBS.getId());
					...
					if (custommerRepre != null
						...
						rawData.append("<custId>" + custommerRepre.getCustId());
						rawData.append("</custId>");
						rawData.append("<idNo>" + custommerRepre.getIdNo());
						rawData.append("</idNo>");
					} else {
						rawData.append("<custGroupId>" + cusGroupId);
						rawData.append("</custGroupId>");
						rawData.append("<busType>" + busType);
						rawData.append("</busType>");
						if (fieldAcObj != null) {
							rawData.append("<fieldActiveId>"
									+ fieldAcObj.getFieldActiveId());
							rawData.append("</fieldActiveId>");
						}

						rawData.append("<custId>"
								+ edtmaKHCD.getText().toString().trim());
						rawData.append("</custId>");

						// thong tin khach hang dai dien
						rawData.append("<name>"
								+ edit_tenKHDD.getText().toString().trim());
						rawData.append("</name>");
						rawData.append("<birthDateStr>"
								+ edit_ngaysinhd.getText().toString().trim());
						rawData.append("</birthDateStr>");

						rawData.append("<sex>" + gioitinh.getAreaCode());
						rawData.append("</sex>");

						rawData.append("<nationality>"
								+ edit_quoctich.getText().toString());
						rawData.append("</nationality>");
...
//								if (typePaperBeans.getParType().equals("1")) {
									...
									rawData.append("</idIssuePlace>");
//								}
								if ("3".equals(typePaperBeans.getParType()) || typePaperBeans.getParType().isEmpty()) {
//									rawData.append("<hc>"
//											+ edit_sogiaytoDD.getText()
//													.toString());
//									rawData.append("</hc>");
...
//								}
						...
						if (areaProvicialPR != null) {
							rawData.append("<province>"
									+ areaProvicialPR.getProvince());
							rawData.append("</province>");
						}

						if (areaPrecintPR != null) {
							rawData.append("<precinct>"
									+ areaPrecintPR.getPrecinct());
							rawData.append("</precinct>");
						}
				...
				if (ActivityCreateNewRequestHotLine.instance.receiveRequestBean != null) {
					if (!CommonActivity
							.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.receiveRequestBean
									.getReciveRequestId())) {
						rawData.append("<requestHotlineId>"
								+ ActivityCreateNewRequestHotLine.instance.receiveRequestBean
										.getReciveRequestId());
						rawData.append("</requestHotlineId>");
					}
				}
//				
				if (ActivityCreateNewRequestHotLine.instance != null && ActivityCreateNewRequestHotLine.instance.infoSubChild != null) {
					SharedPreferences preferences = FragmentConnectionInfoSettingHotLine.this.getSharedPreferences(
							Define.PRE_NAME, Activity.MODE_PRIVATE);

					// bo sung tao yeu cau hotline chuyen doi cong nghe
					if(ActivityCreateNewRequestHotLine.instance.infoSubChild.getHotlineForm() != null ){
						if(!CommonActivity.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.infoSubChild.getHotlineForm().getRequestHotlineId())){
							rawData.append("<requestHotlineId>"
									+ ActivityCreateNewRequestHotLine.instance.infoSubChild.getHotlineForm().getRequestHotlineId());
							rawData.append("</requestHotlineId>");
						}
					}
					
					String name = preferences.getString(Define.KEY_MENU_NAME, "");
					if(name.contains(";permissionChangeInfra;")){
						rawData.append("<isPermissionChangeInfra>"+ true);
						rawData.append("</isPermissionChangeInfra>");
					}else{
						rawData.append("<isPermissionChangeInfra>"+ false);
						rawData.append("</isPermissionChangeInfra>");
					}
					rawData.append("<changeInfraReq>");
					if (!CommonActivity
							.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.infoSubChild
									.getAccount())) {
						rawData.append("<account>"
				...
				if (spinKMTN != null) {
					rawData.append("<promotionCodeUnit>" + spinKMTN.getId());
				...
				if ("F".equals(serviceType)
						...
						|| ("U".equals(serviceType)
								&& FragmentInfoExamineHotLine.groupProductId
										.equals("23") && techology.equals("4"))) {
					if (!CommonActivity
							.isNullOrEmpty(FragmentInfoExamineHotLine.mohinh)) {
						rawData.append("<deployModelOntSfu>"
								+ FragmentInfoExamineHotLine.mohinh);
						rawData.append("</deployModelOntSfu>");
					}
				} else {
					rawData.append("<deployModelOntSfu>" + "");
				...
				if (parentSubId != null && !parentSubId.equals("")) {
					rawData.append("<parentSubId>" + parentSubId);
				...
				rawData.append("<accountPPPOE>"
						+ editisdnoraccPPPOE.getText().toString().trim()
						+ "</accountPPPOE>");
				rawData.append("<passwordPPPOE>"
						+ editmatkhauPPPOE.getText().toString().trim()
						+ "</passwordPPPOE>");
				rawData.append("<account>" + subRequest.getAccount()
						+ "</account>");

				rawData.append("<lineType>" + subRequest.getLineType()
						+ "</lineType>");
				rawData.append("<password>" + subRequest.getPassword()
						+ "</password>");
				rawData.append("<account>" + subRequest.getAccount()
						+ "</account>");
				rawData.append("<subgroup>" + subRequest.getSubgroup()
						+ "</subgroup>");
				rawData.append("<subType>" + subRequest.getSubType()
						+ "</subType>");

				if (subRequest.getPromotionCode() != null
						&& !subRequest.getPromotionCode().isEmpty()) {
					rawData.append("<promotionCode>"
							+ subRequest.getPromotionCode()
							+ "</promotionCode>");
				}else{
					rawData.append("<promotionCode>"
							+ ""
				...
				rawData.append("<regType>" + subRequest.getRegType()
						+ "</regType>");
				rawData.append("<ipStatic>" + subRequest.getIpStatic()
						+ "</ipStatic>");
				rawData.append("<userUsing>" + subRequest.getUserUsing()
						+ "</userUsing>");
				rawData.append("<serviceType>" + subRequest.getServiceType()
						+ "</serviceType>");
				if (subRequest.getProductCode() != null
						&& !subRequest.getProductCode().isEmpty()) {
					rawData.append("<productCode>"
							+ subRequest.getProductCode() + "</productCode>");
				} else {
					rawData.append("<productCode>" + "" + "</productCode>");
				}

				rawData.append("<offerId>" + subRequest.getOfferId()
						+ "</offerId>");
				rawData.append("<technology>" + subRequest.getTechnology()
						+ "</technology>");
				rawData.append("<notificationLevel>"
						+ subRequest.getNotificationLevel()
						+ "</notificationLevel>");
				rawData.append("<telFax>" + subRequest.getTelFax()
						+ "</telFax>");
				rawData.append("<telMobile>" + subRequest.getTelMobile()
						+ "</telMobile>");
				rawData.append("<limitDate>" + subRequest.getLimitDate()
						+ "</limitDate>");
	...
	private class GetConTractAsyn extends
		...
		protected void onPostExecute(ArrayList<ConTractBean> result) {
			...
			if (errorCode.equals("0")) {
				...
				if (arrTractBeans != null && arrTractBeans.size() > 0) {
					arrTractBeans = new ArrayList<ConTractBean>();
				}
		...
		private ArrayList<ConTractBean> sendRequestGetLisContract(String cusId,
			...
			ArrayList<ConTractBean> lstTractBeans = new ArrayList<ConTractBean>();
			String original = "";
			try {
				...
				if (!CommonActivity.isNullOrEmpty(parentSubId)) {
					rawData.append("<subId>" + parentSubId);
					rawData.append("</subId>");
				} else {
					if (!CommonActivity.isNullOrEmpty(mainSubId)) {
						rawData.append("<subId>" + mainSubId);
						rawData.append("</subId>");
					} else {
						rawData.append("<subId>" + "");
						rawData.append("</subId>");
				...
				String envelope = input.buildInputGatewayWithRawData(rawData
						.toString());
				Log.d("Send evelop findContractOld", envelope);
				Log.i("LOG", Constant.BCCS_GW_URL);
				String response = input.sendRequest(envelope,
						Constant.BCCS_GW_URL,
						FragmentConnectionInfoSettingHotLine.this,
				...
				CommonOutput output = input.parseGWResponse(response);
				original = output.getOriginal();
				Log.d("Responseeeeeeeeee original findContractOld", original);
				Log.d("Log", original);
				// ====== parse xml ===================
	...
	private class AsyntaskGetListAllCommon extends
			...
			if (errorCode.equalsIgnoreCase("0")) {
				...
				if (type == TYPE_HTTTHD) {
					...
					Utils.setDataSpinner(
							FragmentConnectionInfoSettingHotLine.this, result,
							spinner_httthd);
					if (!CommonActivity.isNullOrEmpty(conTractBean
							.getContractId())) {
						findViewById(R.id.btnhttthd).setVisibility(View.GONE);
		...
		private ArrayList<Spin> getListContractType() {
			ArrayList<Spin> lstContractType = new ArrayList<Spin>();
			String original = "";
			try {
	...
	public class GetListPstnAsyn extends
		...
		protected void onPostExecute(ArrayList<String> result) {
			...
			if (errorCode.equals("0")) {
				...
				if (result.size() > 0) {
					...
					Dialog dialog = CommonActivity.createAlertDialog(
							FragmentConnectionInfoSettingHotLine.this,
							getResources().getString(R.string.checknotisdn),
							getResources().getString(R.string.app_name));
					dialog.show();
				}
			} else {
		...
		private ArrayList<String> getListPstn(String regType, String offerId,
				String stationId) {
			ArrayList<String> lisPstn = new ArrayList<String>();
			String original = "";
			try {
				BCCSGateway input = new BCCSGateway();
				input.addValidateGateway("username", Constant.BCCSGW_USER);
				...
				rawData.append("<stationId>" + stationId);
				...
				for (int i = 0; i < nl.getLength(); i++) {
					...
					for (int j = 0; j < nodechild.getLength(); j++) {
						...
						String isdnPstn = parse.getCharacterDataFromElement(e1);
	...
	public class GetListNGNAsyn extends
		...
		private ArrayList<String> getListIsdnNGN(String regType,
			...
			ArrayList<String> listIsdnNGN = new ArrayList<String>();
			String original = "";
			try {
				BCCSGateway input = new BCCSGateway();
				input.addValidateGateway("username", Constant.BCCSGW_USER);
		...
		protected void onPostExecute(String result) {
			...
			if (result.equals("0")) {
				if (description.equals("1")) {
					lnIptinh.setVisibility(View.VISIBLE);
					if (!offerId.equals("") && !locationCode.equals("")
	...
	public class GetListProductAsyn extends
		...
		protected void onPostExecute(ArrayList<ObjThongTinHH> result) {
			...
			if (errorCode.equals("0")) {
				...
				if (mArrayListThongTinHH.size() > 0) {
					...
					// adapter.notifyDataSetChanged();
					// }
					// CommonActivity.createAlertDialog(FragmentConnectionInfoSettingHotLine.this,
		...
		private ArrayList<ObjThongTinHH> getListProduct(String regType,
			...
			ArrayList<ObjThongTinHH> arrayListThongTinHH = new ArrayList<ObjThongTinHH>();
			String original = "";
			try {
				BCCSGateway input = new BCCSGateway();
				input.addValidateGateway("username", Constant.BCCSGW_USER);
				...
				for (int i = 0; i < nl.getLength(); i++) {
					...
					for (int j = 0; j < nodechildlstApSaleModelBeanBO
						...
						ArrayList<ObjAPStockModelBeanBO> arrayAPStockModelBeanBO = new ArrayList<ObjAPStockModelBeanBO>();

						Log.d("nodechildlstApSaleModelBeanBO.length : ",
								nodechildlstApSaleModelBeanBO.getLength() + "");
	...
	public void setListView(ArrayList<ObjThongTinHH> arrayListTTHH) {
	...
	public class ViewDetailProductAsyn extends
		...
		private void MapProgramFolowHTCC(String supplyMethod,
				List<SupplyProgramBean> arrSupplyProgramBeans) {
			ArrayList<SupplyProgramBean> lstProgramBeans = new ArrayList<SupplyProgramBean>();
		...
		private void MapMonthFolowProgram(String programmeCode,
				List<SupplyProgramBean> arrSupplyProgramBeans) {
			List<SupplyBaseBean> lstSupplyBaseBeans = new ArrayList<SupplyBaseBean>();
			for (SupplyProgramBean supplyProgramBean : arrSupplyProgramBeans) {
		...
		private void initSpinnerProgram(
			...
			if (lstProgramBeans != null && lstProgramBeans.size() > 0) {
				adapterProgram = new ArrayAdapter<String>(
						FragmentConnectionInfoSettingHotLine.this,
						android.R.layout.simple_dropdown_item_1line,
						android.R.id.text1);
		...
		private void initSpinnerMonths(List<SupplyBaseBean> lstSupplyBaseBeans) {
			...
			if (lstSupplyBaseBeans != null && lstSupplyBaseBeans.size() > 0) {
				adapterMonths = new ArrayAdapter<String>(
						FragmentConnectionInfoSettingHotLine.this,
						android.R.layout.simple_dropdown_item_1line,
						android.R.id.text1);
		...
		private void initSpinnerHTCC(List<SupplyMethodBean> arrSupplyMethodBeans) {
			if (arrSupplyMethodBeans != null && arrSupplyMethodBeans.size() > 0) {
				adapterHTCC = new ArrayAdapter<String>(
						FragmentConnectionInfoSettingHotLine.this,
						android.R.layout.simple_dropdown_item_1line,
						android.R.id.text1);
		...
		public SupplyInforBean parseXmlDetailProduct(String saleServiceCode,
			...
			try {
				...
				rawData.append("<stockModelId>" + stockModelId);
				...
				for (int i = 0; i < nl.getLength(); i++) {
					...
					description = parse.getValue(e2, "description");
					Log.d("description", description);
					ArrayList<SupplyMethodBean> arrSupplyMethod = new ArrayList<SupplyMethodBean>();
					...
					for (int j = 0; j < nodechild.getLength(); j++) {
						...
						ArrayList<SupplyProgramBean> arrSupplyProgramBeans = new ArrayList<SupplyProgramBean>();
						for (int l = 0; l < nodelstSupplyProgramBean
							...
							String programCode = parse.getValue(e4,
									"programCode");
							Log.d("programCode", programCode);
							ArrayList<SupplyBaseBean> arrsupplyBaseBean = new ArrayList<SupplyBaseBean>();
	...
	public class GeneraAccountAsyn extends AsyncTask<String, Void, String> {
		...
		public String generaAccount(String serviceType, String cusName,
			...
			try {
				...
				// idNoOrBusPermitNo
				if (FragmentInfoCustomerHotLine.custommer != null) {
					if (FragmentInfoCustomerHotLine.custommer.getIdNo() != null
							&& !FragmentInfoCustomerHotLine.custommer.getIdNo()
									.isEmpty()) {
						rawData.append("<idNo>"
								+ FragmentInfoCustomerHotLine.custommer
										.getIdNo());
						...
						if (FragmentInfoCustomerHotLine.custommer
								.getBusPermitNo() != null
								&& !FragmentInfoCustomerHotLine.custommer
				...
				if (cusName != null && !cusName.equals("")) {
					rawData.append("<custName>" + Html.escapeHtml(cusName));
	...
	public class GetPromotionByMap extends
		...
		private ArrayList<PromotionTypeBeans> getPromotionTypeBeans(
			...
			try {
				...
				rawData.append("<custGroupId>" + custGroup + "</custGroupId>");
				rawData.append("<busType>" + custType + "</busType>");

				rawData.append("<subGroupId>" + subGroupId + "</subGroupId>");
	...
	public class GetListIpAsyn extends
		...
		private ArrayList<String> getListIP(String offerId, String areaCode) {
			ArrayList<String> lisIp = new ArrayList<String>();
			String original = "";
			try {
				BCCSGateway input = new BCCSGateway();
				input.addValidateGateway("username", Constant.BCCSGW_USER);
				...
				rawData.append("<areaCode>" + areaCode);
				rawData.append("</areaCode>");
				...
				for (int i = 0; i < nl.getLength(); i++) {
					...
					for (int j = 0; j < nodechild.getLength(); j++) {
						...
						String ip = parse.getCharacterDataFromElement(e1);
						Log.d("ip", ip);
						lisIp.add(ip);
					}
				}
	...
	public class GetHTHMAsyn extends
		...
		private ArrayList<HTHMBeans> getListHTHM(String offerId,
			...
			try {
				...
				rawData.append("<custGroupId>" + custGroup);
				rawData.append("</custGroupId>");
				rawData.append("<busType>" + custType);
				rawData.append("</busType>");
				rawData.append("<subGroupId>" + subGroupId);
				rawData.append("</subGroupId>");
				rawData.append("<subType>" + subType);
				rawData.append("</subType>");

				if (ActivityCreateNewRequestHotLine.instance != null && ActivityCreateNewRequestHotLine.instance.infoSubChild != null) {
					if(!CommonActivity.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.infoSubChild.getAccount())){
						
						rawData.append("<isChangeInfraReq>" + true);
						rawData.append("</isChangeInfraReq>");
					}
				}
	...
	private class GetListSubGroupAsyn extends
		...
		protected void onPostExecute(ArrayList<SubGroupBeans> result) {
			...
			if (errorCode.equals("0")) {
				if (result.size() > 0) {
					...
					Dialog dialog = CommonActivity.createAlertDialog(
							FragmentConnectionInfoSettingHotLine.this,
							getResources().getString(R.string.notnhomthuebao),
							getResources().getString(R.string.app_name));
					dialog.show();
		...
		private ArrayList<SubGroupBeans> getLisGroupBeans() {
			ArrayList<SubGroupBeans> lisSubGroupBeans = new ArrayList<SubGroupBeans>();
			String original = "";
			try {
	...
	private void addActionBarTitle() {
		...
		ActionBar mActionBar = FragmentConnectionInfoSettingHotLine.this
				.getActionBar();
	...
	public class GetContractOfferByContractIdAsynTask extends
		...
		public ArrayList<ContractOffersObj> sendRequestGetContractOfferByContractId(
			...
			ArrayList<ContractOffersObj> listContractOffersObj = new ArrayList<ContractOffersObj>();
			...
			try {
				...
				rawData.append("<input>");
				rawData.append("<token>" + Session.getToken() + "</token>");
				rawData.append("<contractId>" + strCosntractId
						+ "</contractId>");
				rawData.append("</input>");
				rawData.append("</ws:getContractOfferByContractId>");
				Log.i("RowData", rawData.toString());
	...
	public class GetListFieldActivesAsynTask extends
		...
		public ArrayList<ActivesObj> sendRequestGetListFieldActives() {
			ArrayList<ActivesObj> listActivesObj = new ArrayList<ActivesObj>();
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 3333) {
			if (resultCode == Activity.RESULT_OK) {
				...
				if (data != null) {
					bank = (Bank) data.getExtras().getSerializable("bankPrKey");
					if (bank != null) {
		...
		if (requestCode == 1001) {
			if (resultCode == Activity.RESULT_OK) {
				...
				HTHMBeans hthmBeans = (HTHMBeans) data.getExtras()
						.getSerializable("HTHMBeans");
				if (hthmBeans != null) {
...
//						txtchonkm.setText(getString(R.string.selectMKM));
						...
						getAllListPaymentPrePaidAsyn.execute(maKM,
								productCode, txttinhTP.getText().toString()
										.trim()+ txtquanhuyen.getText().toString().trim()
										+ txtphuongxa.getText().toString().trim(), dateNowString);
					}
				} else {
					maKM = "-1";
					txtchonkm.setText(getString(R.string.chonctkm1));
	...
	private void initTypePaper() {
		...
		try {
			dal = new GetTypePaperDal(FragmentConnectionInfoSettingHotLine.this);
			dal.open();
	...
	public class GetBankAsyn extends AsyncTask<String, Void, ArrayList<Bank>> {
		...
		protected void onPostExecute(ArrayList<Bank> result) {
			...
			if (errorCode.equals("0")) {
				...
				if (result.size() > 0) {
					...
					Dialog dialog = CommonActivity.createAlertDialog(
							FragmentConnectionInfoSettingHotLine.this,
							getResources().getString(R.string.notnganhang),
							getResources().getString(R.string.app_name));
					dialog.show();
		...
		private ArrayList<Bank> getListBank(String bankCode) {
			...
			try {
				...
				rawData.append("<bankCode>" + bankCodeUtf);
				rawData.append("</bankCode>");
				rawData.append("</input>");
				rawData.append("</ws:getBankByCode>");
				Log.i("RowData", rawData.toString());
	...
	private ArrayList<Bank> arrBanks = new ArrayList<Bank>();
	...
	private ArrayList<ConTractBean> arrTractBeansDialog = new ArrayList<ConTractBean>();
	...
	private void showDialogSelectContract(
		...
		arrTractBeansDialog = new ArrayList<ConTractBean>();
		...
		lvContract.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (conTractBean != null && arg2 > 0) {
					...
					if(conTractBean != null && !CommonActivity.isNullOrEmpty(conTractBean.getContractId())){
						reloadHDOld(conTractBean);
						GetContractOfferByContractIdAsynTask getContractOfferByContractIdAsynTask = new GetContractOfferByContractIdAsynTask(
								FragmentConnectionInfoSettingHotLine.this);
						getContractOfferByContractIdAsynTask
	...
	private void showDiaLogSelectCus(
		...
		final Dialog dialogCus = new Dialog(
				FragmentConnectionInfoSettingHotLine.this);
		...
		adaGetListCusAdapter = new GetListCusAdapter(arrCustommerByIdNoBeans,
				FragmentConnectionInfoSettingHotLine.this);
	...
	private void showSelectCuocDongTruoc(
		...
		dialogCuocdongtruoc = new Dialog(
				FragmentConnectionInfoSettingHotLine.this);
	...
	private class AsynGetPromotionUnit extends
		...
		protected void onPostExecute(ArrayList<Spin> result) {
			...
			if (errorCode.equalsIgnoreCase("0")) {
				...
				Utils.setDataSpinner(FragmentConnectionInfoSettingHotLine.this,
