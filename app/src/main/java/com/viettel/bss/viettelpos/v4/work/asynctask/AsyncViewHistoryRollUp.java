...
public class AsyncViewHistoryRollUp extends
	...
	public AsyncViewHistoryRollUp(String programId, String fromDate,
		...
		progress.setMessage(context
				.getString(R.string.getting_roll_up_history));
	...
	private RollUpOutput doAction() {
		...
		String original = "";
		RollUpOutput result;
		String methodName = "viewHistoryRollUp";
		try {
