...
class StaffBeansHandler extends DefaultHandler {
	...
	public StaffBeansHandler(String xmlTagName) {
		super();
	...
	public void startElement(String uri, String localName, String qName,
		...
		} else if (localName.equalsIgnoreCase(xmlTagName)) {
	...
	public void endElement(String uri, String localName, String qName)
		...
		} else if (localName.equalsIgnoreCase("telFax")) {
