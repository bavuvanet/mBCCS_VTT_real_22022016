...
public class DateTimePicker extends DialogFragment {
	...
	private View createDateTimeView(LayoutInflater layoutInflater) {
		...
		@SuppressLint("InflateParams") View mView = layoutInflater.inflate(R.layout.layout_date_time_picker, null);
		// Extract the TabHost
		...
		mDateTab.setIndicator(getString(R.string.txt_tab_date));
		...
		mTimeTab.setIndicator(getString(R.string.txt_tab_time));
