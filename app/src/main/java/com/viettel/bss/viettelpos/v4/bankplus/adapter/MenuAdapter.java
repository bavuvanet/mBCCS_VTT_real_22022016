...
public class MenuAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		gridView = inflater.inflate(R.layout.layout_bankplus_menu_item, arg2, false);
		ImageView img = (ImageView) gridView.findViewById(R.id.imgIcon);
		TextView tvFunctionName = (TextView) gridView.findViewById(R.id.tvFunctionName);
		TextView tvFunctionDescription = (TextView) gridView.findViewById(R.id.tvFunctionDescription);
