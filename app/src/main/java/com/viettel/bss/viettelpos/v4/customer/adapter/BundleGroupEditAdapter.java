...
public class BundleGroupEditAdapter extends BaseAdapter {
	...
	public View getView(final int position, View arg1, ViewGroup arg2) {
		...
		if (mView == null) {
			...
			mView = inflater.inflate(R.layout.layout_bundle_group_edit_item,
					arg2, false);
		...
		if (item.getIsAdd()) {
			holder.tvSub.setTextColor(mContext.getColor(
					R.color.blue_light));
			holder.tvService.setTextColor(mContext.getColor(
					R.color.blue_light));
