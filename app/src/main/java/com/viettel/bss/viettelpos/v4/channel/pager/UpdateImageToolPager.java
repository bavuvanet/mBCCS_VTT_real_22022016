...
import com.viettel.bss.viettelpos.v4.channel.activity.FragmentUpdateImageTools;
...
public class UpdateImageToolPager extends Page{

	public UpdateImageToolPager(ModelCallbacks callbacks, String title) {
	...
	public Fragment createFragment() {
		...
		return FragmentUpdateImageTools.create(getKey());
	}
