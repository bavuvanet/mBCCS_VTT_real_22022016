...
public class AsyncLstTimeMoney extends AsyncTask<Void, Void, SaleOutput>{
	private OnPostExecute<SaleOutput> onPostExecute;
	private Context context;
	private ProgressDialog progress;
	public AsyncLstTimeMoney(
			OnPostExecute<SaleOutput> onPostExecute, Context context) {
		super();
		progress = new ProgressDialog(context);
		progress.setMessage(context.getString(R.string.getting_config_tickpoint));
	...
	private SaleOutput lstTimeMoney() {
		...
		String original = "";
		SaleOutput result;
		String methodName = "lstTimeMoney";
		try {
