...
public class SlidingTabStrip extends LinearLayout {
    ...
    private static final byte DEFAULT_BOTTOM_BORDER_COLOR_ALPHA = 0x40;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < childCount - 1; i++) {
            ...
            canvas.drawLine(child.getRight() + params.getMarginEnd(), separatorTop, child.getRight() + params.getMarginEnd(),
