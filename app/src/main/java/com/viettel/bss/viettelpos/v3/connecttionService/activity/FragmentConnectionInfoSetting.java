...
public class FragmentConnectionInfoSetting extends GPSTracker implements
	...
	private void showDatePickerSign(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearsignDate, monthsignDate, daysignDate);
		}
	...
	private void showDatePickerEffectDate(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yeareffectDate, montheffectDate, dayeffectDate);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerExpireDate(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearexpireDate, monthexpireDate, dayexpireDate);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerSignContractOffer(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearsignDateContractOffer,
	...
	private void showDatePickerIssueDateOffer(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearissueDateOffer, monissueDateOffer,
					dayissueDateOffer);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	...
	private void showDatePickerbirhDateDD(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearbirhDateDD, monbirhDateDD, daybirhDateDD);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerissueDateDD(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearissueDateDD, monissueDateDD, dayissueDateDD);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	private void showDatePickerNgaynhothu(final EditText edtngaycap) {
		...
		if (!CommonActivity.isNullOrEmpty(edtngaycap.getText().toString())) {
			...
			pic = new FixedHoloDatePickerDialog(FragmentConnectionInfoSetting.this, AlertDialog.THEME_HOLO_LIGHT,
					callback, yearngaynhothu, monngaynhothu, dayngaynhothu);
		}
		pic.setTitle(getString(R.string.chon_ngay));
		pic.show();
	}
	...
	public void unitView() {
		...
		if (CommonActivity
				.isNetworkConnected(FragmentConnectionInfoSetting.this) == true) {
			...
			try {
				...
				if (custommer.getCustId() != null
					...
					rawData.append("<areaCode>" + custommer.getProvince()
							+ custommer.getDistrict() + custommer.getPrecint()
							+ custommer.getStreet_block());
				...
				if (!CommonActivity.isNullOrEmpty(conTractBean.getContractId())) {
					...
					rawData.append("<payer>"
							+ Html.escapeHtml(edtnguoithanhtoan.getText()
									.toString().trim()));
					rawData.append("</payer>");
					...
					if (custommerRepre != null
						...
						if (typePaperBeans != null) {
							...
							if (typePaperBeans.getParType() != null) {
								...
								// {
								rawData.append("<idNo>"
										+ edit_sogiaytoDD.getText().toString());
								rawData.append("</idNo>");
	...
	private void addActionBarTitle() {
		...
		ActionBar mActionBar = FragmentConnectionInfoSetting.this
				.getActionBar();
		...
		btnHome.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				CommonActivity.callphone(FragmentConnectionInfoSetting.this,
				...
				if (promotionTypeBeans != null) {
					if (!CommonActivity.isNullOrEmpty(promotionTypeBeans
						...
						getAllListPaymentPrePaidAsyn.execute(maKM, productCode,
								txttinhTP.getText().toString().trim()
										+ txtquanhuyen.getText().toString()
												.trim()
										+ txtphuongxa.getText().toString()
												.trim(), dateNowString);
