...
public class GetProvinceAdapter extends BaseAdapter {
	...
	public GetProvinceAdapter(ArrayList<AreaBean> arr, Context context) {
		if (arr != null) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (customerGroupBeans != null
				&& !CommonActivity.isNullOrEmpty(customerGroupBeans
						.getNameProvince())) {
			holder.txtpstn.setText(customerGroupBeans.getProvince() +" "+ customerGroupBeans.getNameProvince());
		}
		...
		if (chartext.isEmpty()) {
			...
			for (AreaBean customerGroupBeans : arraylist) {
				if ( CommonActivity
						...
						.convertCharacter1(
								customerGroupBeans.getNameProvince())
						.toLowerCase()
						.contains(
