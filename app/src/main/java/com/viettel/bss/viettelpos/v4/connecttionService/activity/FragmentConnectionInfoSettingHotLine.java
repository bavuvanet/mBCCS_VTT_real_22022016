...
@SuppressLint("NewApi")
public class FragmentConnectionInfoSettingHotLine extends GPSTracker implements
	...
	private static final int TYPE_HTTTHD = 1;
		...
		spinner_type_giay_to_parent
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						if (typePaperBeans.getParType().isEmpty()
	...
	private final OnClickListener moveLogInAct = new OnClickListener() {
		...
		public void onClick(View v) {
			// Intent intent = new
			// Intent(FragmentConnectionInfoSettingHotLine.this,
			// LoginActivity.class);
		...
		private void luuHopDong(String province, String district,
			...
			try {
				...
				if (custommer.getCustId() != null
					...
					rawData.append("<name>").append(custommer.getNameCustomer());
					rawData.append("</name>");
				...
				if (custommer.getCustomerAttribute() != null) {
					if (!CommonActivity.isNullOrEmpty(custommer
						...
						rawData.append("<issuePlace>"
								+ StringUtils
										.escapeHtml(StringUtils.escapeHtml(custommer
												.getCustomerAttribute()
												.getIssuePlace())));
						rawData.append("</issuePlace>");
						rawData.append("<name>").append(custommer.getCustomerAttribute().getName());
						rawData.append("</name>");
						rawData.append("</customerAttribute>");
					}
				}
				...
				if (!CommonActivity.isNullOrEmpty(conTractBean.getContractId())) {
					...
					rawData.append("<account>").append(edttkoanhd.getText().toString().trim());
					...
					rawData.append("<email>").append(edtemailtbc.getText().toString().trim());
					...
					if (custommerRepre != null
						...
						rawData.append("<nationality>"
								+ StringUtils.escapeHtml(edit_quoctich.getText().toString()));
						rawData.append("</nationality>");
						...
						if (typePaperBeans != null) {
							...
							if (typePaperBeans.getParType() != null) {
								...
								rawData.append("<idIssuePlace>"
										+ StringUtils.escapeHtml(edtnoicap
												.getText().toString()));
								rawData.append("</idIssuePlace>");
								// }
				...
				SharedPreferences preferences1 = FragmentConnectionInfoSettingHotLine.this
						.getSharedPreferences(Define.PRE_NAME,
								Activity.MODE_PRIVATE);
				String name1 = preferences1.getString(Define.KEY_MENU_NAME, "");
				if (name1.contains(";menu.deposit;")) {
				...
				if (ActivityCreateNewRequestHotLine.instance.receiveRequestBean != null) {
					if (!CommonActivity
							.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.receiveRequestBean
									.getReciveRequestId())) {
						rawData.append("<requestHotlineId>").append(ActivityCreateNewRequestHotLine.instance.receiveRequestBean
                                .getReciveRequestId());
				...
				if (ActivityCreateNewRequestHotLine.instance != null
					...
					SharedPreferences preferences = FragmentConnectionInfoSettingHotLine.this
							.getSharedPreferences(Define.PRE_NAME,
									Activity.MODE_PRIVATE);

					// bo sung tao yeu cau hotline chuyen doi cong nghe
					if (ActivityCreateNewRequestHotLine.instance.infoSubChild
							.getHotlineForm() != null) {
						if (!CommonActivity
								.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.infoSubChild
										.getHotlineForm().getRequestHotlineId())) {
							rawData.append("<requestHotlineId>").append(ActivityCreateNewRequestHotLine.instance.infoSubChild
                                    .getHotlineForm()
                                    .getRequestHotlineId());
							rawData.append("</requestHotlineId>");
						}
					...
					if (!CommonActivity
							.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.infoSubChild
									.getAccount())) {
						rawData.append("<account>").append(ActivityCreateNewRequestHotLine.instance.infoSubChild
                                .getAccount());
						rawData.append("</account>");
					}
					if (!CommonActivity
							.isNullOrEmpty(ActivityCreateNewRequestHotLine.instance.infoSubChild
									.getServiceType())) {
						rawData.append("<serviceType>").append(ActivityCreateNewRequestHotLine.instance.infoSubChild
                                .getServiceType());
				...
				if ("F".equals(serviceType)
					...
					if (!CommonActivity
						...
						rawData.append("<deployModelOntSfu>").append(FragmentInfoExamineHotLine.mohinh);
				...
				rawData.append("<userUsing>" + StringUtils.escapeHtml(subRequest.getUserUsing())
						+ "</userUsing>");
				...
				if (description.equals("1")) {
					...
					if (!CommonActivity.isNullOrEmpty(offerId)) {
						...
						if(!CommonActivity.isNullOrEmpty(locationLD)){
							new GetListIpAsyn(FragmentConnectionInfoSettingHotLine.this)
				...
				if (FragmentInfoCustomerHotLine.custommer != null) {
					if (FragmentInfoCustomerHotLine.custommer.getIdNo() != null
							&& !FragmentInfoCustomerHotLine.custommer.getIdNo()
									.isEmpty()) {
						rawData.append("<idNo>").append(FragmentInfoCustomerHotLine.custommer
                                .getIdNo());
						rawData.append("</idNo>");
					} else {
						if (FragmentInfoCustomerHotLine.custommer
							...
							rawData.append("<busPermitNo>").append(FragmentInfoCustomerHotLine.custommer
                                    .getBusPermitNo());
							rawData.append("</busPermitNo>");
						}
					}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == 107) {
			if (data != null) {
				...
				edtprecinct.setText("");
				edtprecinct.setHint(FragmentConnectionInfoSettingHotLine.this
