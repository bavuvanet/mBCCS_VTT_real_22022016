...
public class Config {
    ...
    private final int mTabSelectionIndicatorColor;
    private int mSelectionLimit;
    private final int mCameraButtonColor;
     ...
     */
    private Config(int tabBgColor, int tabSelectionIndicatorColor, int selectionLimit, int cameraButtonColor) {
    ...
    public static class Builder {
        ...
        public Builder setTabBackgroundColor(@ColorRes int colorRes) {
            if (colorRes == 0 || colorRes == -1) {
                throw new IllegalArgumentException("Invalid value for color " + colorRes);
            }
