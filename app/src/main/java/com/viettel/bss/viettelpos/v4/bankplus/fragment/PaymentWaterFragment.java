...
import com.viettel.bss.viettelpos.v4.bankplus.fragment.PaymentTelevisionFragment.ViewHolder;
...
public class PaymentWaterFragment extends FragmentCommon{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		idLayout = R.layout.fragment_payment_water;
	}
	...
	public void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		setTitleActionBar(getString(R.string.bankplus_menu_payment_invoice) + " " + getString(R.string.bankplus_payment_water));
	}
	...
	private void initMerchant() {
		...
		data.append(BPConstant.MERCHANT.NUOC).append(
				Constant.STANDARD_CONNECT_CHAR);
				...
				new OnPostExecuteListener<BankPlusOutput>() {
					...
					public void onPostExecute(BankPlusOutput result,
						...
						if("0".equals(errorCode)){
							...
							holder.tvBillCycle.setText(Html.fromHtml(getString(R.string.bankplus_bill_cycle, CommonActivity.isNullOrEmpty(result.getCycleBill()) ? "" : result.getCycleBill())));
	...
	private void doPayment() {
		...
		StringBuilder data = new StringBuilder();
		data.append(Session.token).append(Constant.STANDARD_CONNECT_CHAR);
		data.append(BPConstant.COMMAND_PAYMENT_WATER).append(
				Constant.STANDARD_CONNECT_CHAR);
	...
	private void showDialogSuccess(){
		...
		DialogFragment newFragment = DialogConfirmCreateBankplusTrans
				.newInstance(getString(R.string.bankplus_menu_payment_invoice) + " " + getString(R.string.bankplus_payment_water),
						getString(R.string.bankplus_payment_water_success), R.drawable.ic_success, null);
	...
	private void showDialogConfirm() {
		...
		String msg = getString(R.string.bankplus_confirm_payment_water, 
		...
		String title = getString(R.string.bankplus_title_confirm_payment_water);
		DialogFragment newFragment = DialogConfirmCreateBankplusTrans
