...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static void encode( java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded ){
        ...
        while( raw.hasRemaining() ){
            ...
            raw.get(raw3,0,rem);
            UtilsBase64.encode3to4(enc4, raw3, rem, UtilsBase64.NO_OPTIONS );
            encoded.put(enc4);
        }   // end input remaining
    }
     ...
     * the method will throw an java.io.IOException. <b>This is new to v4.3!</b>
     ...
     * @return The Base64-encoded object
     * @see UtilsBase64#GZIP
     * @see UtilsBase64#DO_BREAK_LINES
     * @throws java.io.IOException if there is an error
     * @since 2.0
     */
    ...
    throws java.io.IOException {
        ...
        try {
            ...
            b64os = new UtilsBase64.OutputStream( baos, ENCODE | options );
            if( (options & GZIP) != 0 ){
                // Gzip
    ...
    public static byte[] encodeBytesToBytes(byte[] source ) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes( source, 0, source.length, UtilsBase64.NO_OPTIONS );
        } catch( java.io.IOException ex ) {
    ...
    private static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options) throws java.io.IOException {
        ...
        if( (options & GZIP) != 0 ) {
            java.io.ByteArrayOutputStream  baos  = null;
            java.util.zip.GZIPOutputStream gzos  = null;
            UtilsBase64.OutputStream            b64os = null;
...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    throws java.io.IOException {
        byte[] decoded = null;
//        try {
            decoded = decode( source, 0, source.length, UtilsBase64.NO_OPTIONS );
//        } catch( java.io.IOException ex ) {
//            assert false : "IOExceptions only come from GZipping, which is turned off: " + ex.getMessage();
//        }
        return decoded;
    ...
    throws java.io.IOException {
        ...
        UtilsBase64.OutputStream bos = null;
        try {
            bos = new UtilsBase64.OutputStream( 
                  new java.io.FileOutputStream( filename ), UtilsBase64.ENCODE );
    ...
    throws java.io.IOException {
        ...
        try{
            bos = new UtilsBase64.OutputStream( 
                      new java.io.FileOutputStream( filename ), UtilsBase64.DECODE );
    ...
    throws java.io.IOException {
        ...
        UtilsBase64.InputStream bis = null;
        try
        {
            ...
            // Open a stream
            bis = new UtilsBase64.InputStream( 
                      new java.io.BufferedInputStream( 
                      new java.io.FileInputStream( file ) ), UtilsBase64.DECODE );
    ...
    throws java.io.IOException {
        ...
        try
        {
            // Set up some useful variables
            java.io.File file = new java.io.File( filename );
            byte[] buffer = new byte[ Math.max((int)(file.length() * 1.4+1),40) ]; // Need max() for math on small files (v4.2.1); Need +1 for a few corner cases (v4.3.5)
            int length   = 0;
            int numBytes = 0;
            ...
            bis = new UtilsBase64.InputStream( 
                      new java.io.BufferedInputStream( 
                      new java.io.FileInputStream( file ) ), UtilsBase64.ENCODE );
            ...
            // Save in a variable to return
            encodedData = new String( buffer, 0, length, UtilsBase64.PREFERRED_ENCODING );
    ...
    throws java.io.IOException {
        ...
        String encoded = UtilsBase64.encodeFromFile( infile );
    ...
    throws java.io.IOException {
        ...
        byte[] decoded = UtilsBase64.decodeFromFile( infile );
        java.io.OutputStream out = null;
        try{
            out = new java.io.BufferedOutputStream(
                  new java.io.FileOutputStream( outfile ) );
    ...
    /**
     * A {@link UtilsBase64.InputStream} will read data from another
    ...
    public static class InputStream extends java.io.FilterInputStream {
        ...
        /**
         * Constructs a {@link UtilsBase64.InputStream} in DECODE mode.
         *
        ...
        /**
         * Constructs a {@link UtilsBase64.InputStream} in
         ...
         * @param in the <tt>java.io.InputStream</tt> from which to read data.
         * @param options Specified options
         * @see UtilsBase64#ENCODE
         * @see UtilsBase64#DECODE
         * @see UtilsBase64#DO_BREAK_LINES
         * @since 2.0
         */
    ...
    /**
     * A {@link UtilsBase64.OutputStream} will write data to another
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Constructs a {@link UtilsBase64.OutputStream} in ENCODE mode.
         *
        ...
        /**
         * Constructs a {@link UtilsBase64.OutputStream} in
         * either ENCODE or DECODE mode.
         * <p>
         * Valid options:<pre>
         *   ENCODE or DECODE: Encode or Decode as data is read.
            ...
            // Else, Decoding
                ...
                if( decodabet[ theByte & 0x7f ] > WHITE_SPACE_ENC ) {
                    ...
                    if( position >= bufferLength ) { // Enough to output.
                        ...
                        int len = UtilsBase64.decode4to3( buffer, 0, b4, 0, options );
                        out.write( b4, 0, len );
                        position = 0;
                    }   // end if: enough to output
