...
public class AsyncFindActiveByProvinceCode extends
	...
	public AsyncFindActiveByProvinceCode(
			OnPostExecute<RollUpOutput> onPostExecute, Context context) {
		super();
		progress = new ProgressDialog(context);
		progress.setMessage(context.getString(R.string.searching_program));
	...
	private RollUpOutput doAction() {
		...
		String original = "";
		RollUpOutput result;
		String methodName = "findActiveByProvinceCode";
		try {
