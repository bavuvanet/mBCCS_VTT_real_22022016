...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    /*
    Icons for the Sliding tab layout
     */
    /*private static final int[] icons = {R.drawable.notification_white, R.drawable.my_cards_white,
            R.drawable.smartview,
            R.drawable.contacts_list_white, R.drawable.settings_white};*/

    private final int mTitleOffset;

    int mTabViewLayoutId;
    int mTabViewImageViewId;
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        //mTabStrip.setBackgroundColor(getResources().getColor(R.color.app_bg_dark));
     ...
     *
     * If you only require simple custmization then you can use
     ...
     * @param ImageViewId id of the {@link android.widget.TextView} in the inflated view
     */
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mTabViewLayoutId != 0) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(mTabViewLayoutId, mTabStrip,
                        false);
                tabTitleView = (ImageView) tabView.findViewById(mTabViewImageViewId);

                Log.v(TAG, "#populateTabStrip: tab_view_layout is not null");
            }

            if (tabView == null) {
                Log.v(TAG, "#populateTabStrip: tab view is null");
                tabView = createDefaultTabView(getContext());
            }

            if (tabTitleView == null && ImageView.class.isInstance(tabView)) {

                Log.v(TAG, "#populateTabStrip: tabtitleView is null");
                tabTitleView = (ImageView) tabView;
            }

            // tabTitleView.setImageResource(icons[i]);
