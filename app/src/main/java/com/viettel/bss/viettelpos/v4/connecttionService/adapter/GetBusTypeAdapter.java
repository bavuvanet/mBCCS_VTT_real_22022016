...
public class GetBusTypeAdapter extends BaseAdapter{
	private final Context mContext;
	private final ArrayList<BusTypeBean> arrCustomerGroupBeans  = new ArrayList<>();
    private final ArrayList<BusTypeBean> arraylist = new ArrayList<>();
	public GetBusTypeAdapter(ArrayList<BusTypeBean> arr, Context context) {
		if(arr != null){
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		BusTypeBean customerGroupBeans = arrCustomerGroupBeans.get(arg0);
	...
	public ArrayList<BusTypeBean> SearchInput(String chartext){
		...
		if(chartext.isEmpty()){
			...
			for (BusTypeBean customerGroupBeans : arraylist) {
