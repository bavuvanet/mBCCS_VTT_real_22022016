...
public class HTHMMobileHandler extends DefaultHandler{
	...
	public void endElement(String uri, String localName, String qName)
		...
		}else if (localName.equalsIgnoreCase("lstCharacterCode")) {
			if ("DAT_COC".equalsIgnoreCase(currentValue)) {
				temp.setDeposit(true);
			}
		}else if (localName.equalsIgnoreCase("lstReasonDTOProduct")) {
			lstData.add(temp);
		}
