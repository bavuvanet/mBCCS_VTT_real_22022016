...
public class GetDistrictAdapter extends BaseAdapter {
	...
	public GetDistrictAdapter(ArrayList<AreaBean> arr, Context context) {
		if (arr != null) {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (customerGroupBeans != null
				&& !CommonActivity.isNullOrEmpty(customerGroupBeans
						.getNameDistrict())) {
			holder.txtpstn.setText(customerGroupBeans.getDistrict() + " "+customerGroupBeans.getNameDistrict());
		}
	...
	public ArrayList<AreaBean> SearchInput(String chartext) {
		...
		if (chartext.isEmpty()) {
			...
			for (AreaBean customerGroupBeans : arraylist) {
				if ( CommonActivity
						.convertCharacter1(
								customerGroupBeans.getDistrict())
						.toLowerCase()
						.contains(
								CommonActivity.convertCharacter1(chartext)) || CommonActivity
						.convertCharacter1(
								customerGroupBeans.getNameDistrict())
						.toLowerCase()
						.contains(
