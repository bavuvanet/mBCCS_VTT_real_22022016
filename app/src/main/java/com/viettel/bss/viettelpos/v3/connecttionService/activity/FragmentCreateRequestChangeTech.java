...
public class FragmentCreateRequestChangeTech extends Fragment implements
	...
	private ArrayList<Spin> lstTech = new ArrayList<Spin>();
	...
	private ArrayList<InfoSubChild> arrInfoSubChilds = new ArrayList<InfoSubChild>();
	...
	private void unitView(View mView2) {
		...
		btn_apply = (Button) mView2.findViewById(R.id.btn_apply);
	...
	private class AsyntaskGetInfraTypeList extends
		...
		private ArrayList<Spin> getInfraTypeList(String account,
			...
			ArrayList<Spin> lstInfraType = new ArrayList<Spin>();
			String original = "";
			try {
	...
	OnClickListener onclickChangeTech = new OnClickListener() {
			...
			try {
				...
				if (arrInfoSubChilds != null && !arrInfoSubChilds.isEmpty()) {
					for (InfoSubChild infoSubChild : arrInfoSubChilds) {
						...
						rawData.append("<account>" + infoSubChild.getAccount()
								+ "</account>");
	...
	OnClickListener chuyendoiClick = new OnClickListener() {
	...
	private ArrayList<InfoSubChild> lstInfoSubChilds = new ArrayList<InfoSubChild>();
