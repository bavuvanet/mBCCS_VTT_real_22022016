	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtdistrict.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(FragmentLoadMap.this,
					...
					if (!parValueTechology.equals("")
						...
						if (arrSurveyOnlines.size() > 1) {
							...
							GetConectorCodeAdapter adapCodeAdapter = new GetConectorCodeAdapter(
									arrSurveyOnlines, FragmentLoadMap.this);
...
//					}
		...
		btncall.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if (txtdtlienhePSTN.getText().toString() != null
					...
					Toast.makeText(FragmentLoadMap.this,
		...
		btnkiemtra.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (txtmahopcap.getText() != null
					...
					if (CommonActivity.isNetworkConnected(FragmentLoadMap.this) == true) {
	...
	private void addActionBar() {
		...
		btnHome.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				CommonActivity.callphone(FragmentLoadMap.this,
			...
			if (errorCode.equals("0")) {
				...
				if (errorCode.equals(Constant.INVALID_TOKEN2)) {
					...
					Dialog dialog = CommonActivity
							.createAlertDialog(FragmentLoadMap.this,
					...
					Dialog dialog = CommonActivity.createAlertDialog(
							FragmentLoadMap.this, description, getResources()
		...
		private SysUsersBO getUserFromCableBoxADSL(String cableCode) {
			...
			try {
				...
				String response = input.sendRequest(envelope,
						Constant.BCCS_GW_URL, FragmentLoadMap.this,
